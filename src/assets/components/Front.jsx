...
function Front() {
  ...
  return (
    ...
    <div className='h-screen pt-[17vh] md:pt-[25vh] mt-[60px] md:mt-0 bg-[#9abddfff]'>
        ...
        <div>
        <button onClick={handleClick} className='h-[50px] md:h-[50px] w-[200px] md:w-[230px] text-white font-semibold text-[15px] md:text-[17px] bg-[#075197] duration-300 hover:bg-[#200459] rounded-[5px] ml-5 md:ml-17'>Get Started Now !</button>
        <button onClick={handleClick2} className='h-[50px] md:h-[50px] w-[135px] md:w-[175px]  text-[#075197] font-semibold text-[15px] md:text-[17px] bg-white duration-300 hover:bg-[#200459] hover:text-white rounded-[5px] mx-2'>Contact Us</button>
        </div>
    </div>
    </>
  )
