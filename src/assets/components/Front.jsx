...
function Front() {
  return (
    <>
    <div className='h-screen pt-[17vh] md:pt-[25vh] bg-[#9abddfff]'>
        <h3 className='w-[90vw] md:w-[50vw] text-[40px] md:text-[55px] text-[#0b274b] leading-12 md:leading-14 font-bold mx-5 md:mx-17'>TechServe Computer Academy - where knowledge meets innovation!</h3>
