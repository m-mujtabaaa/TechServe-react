        ...
        <div className="bg-gray-200 w-full py-12 px-[2vw] w-full">
          <div className="bg-white min-h-screen px-5 py-4 rounded">
            ...
            {active === "profile" && (
              <>
                ...
                <div className='border-1 border-gray-400 p-3 rounded my-5'>
                  ...
                  <table className='w-full my-2 hidden md:block'>
                    ...
                    <div className='flex justify-between text-center p-1 border-1 border-gray-400'>
                      ...
                      <p className='bg-green-200 w-[140px] text-center text-green-900 border-1 border-green-400 text-sm rounded-md'>Paid</p>
                    </div>
                  </table>

                   <div className="md:hidden space-y-4">
                    <div className="border rounded-lg p-4">
                      <p><b>Month:</b> January</p>
                      <p><b>Amount:</b> PKR 3000 -/</p>
                      <p><b>Due:</b> 08-Jan-2025</p>
                      <p><b>Voucher:</b> 123456</p>
                      <p><b>Paid On:</b> 06-Jan-2025</p>
                      <p className='bg-green-200 w-[140px] text-center text-green-900 border-1 border-green-400 text-sm rounded-md'>Paid</p>
                    </div>
                    </div>
                </div>
            ...
            {active === "fees" && (
              <div>
                <div className='border-1 border-gray-400 p-3 rounded my-5'>
                  <h3 className='text-[#13345B] text-3xl font-bold inline py-5'>Fee :</h3>

                  <table className='w-full my-5 hidden md:block'>
                    <div className='flex justify-between p-1 border-1 border-gray-400 bg-gray-200 '>
                      <th className='w-[140px]'>Month</th>
                      <th className='w-[140px]'>Ammount</th>
                      <th className='w-[140px]'>Due Date</th>
                  ...
                  <div className="md:hidden space-y-4">
                    ...
                    <div className="border rounded-lg p-4">
                      <p><b>Month:</b> February</p>
                      <p><b>Amount:</b> PKR 3000 -/</p>
                      <p><b>Due:</b> 08-Feb-2026</p>
                      <p><b>Status:</b> Pending</p>
                      <p className='bg-gray-200 w-[140px] text-center text-gray-900 border-1 border-gray-400 text-sm rounded-md'>Pending</p>
                    </div>
                  </div>
            ...
            {active === "attendance" && (
              <div>
                ...
                <div className='border-1 border-gray-400 p-3 rounded my-5'>
                  <h3 className='text-[#13345B] text-3xl font-bold inline py-5'>Attendence Details:</h3>

                  {/* Toggle Button */}
                  <button
                    onClick={() => setMonthOpen(!monthOpen)}
                    className="w-full md:w-[12vw] flex justify-between items-center float-right px-4 py-2 bg-[#075197] text-white rounded"
                  >
                    {selected}
                    <ChevronDown
                  ...
                  {/* Dropdown */}
                  {monthOpen && (
                    <div className="mt-2 w-full border rounded shadow bg-white clear-both">
                      {months
                        .filter((m) => m !== selected)
                        .map((month) => (
                          <button
                  ...
                  {selected === "January" && <table className='w-full my-5'>
                    <div className='flex justify-between p-1 border-1 border-gray-400 mt-4 bg-gray-200 '>
